      ...
      <?php
	      if	(isset($cssfile)){
		      foreach($cssfile as $value){
			      echo '<link href="'.$value.'" type="text/css" rel="stylesheet" media="screen"/> ';
          }
	      }		
	    ?>
  </head>
      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            ...
            <form class="navbar-form pull-left" role="search" action="index.php?rt=sysu_index/result" method="post">
            <div class="form-group">
              <input type="text" class="form-control" name="searchname" placeholder="搜索话题、人"> 
